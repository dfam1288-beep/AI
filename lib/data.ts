...
export const reviews = [
  ...
  },
  {
    id: 2,
    name: "Мария Д.",
    text: "Ламинирование бровей — это лучшее, что я сделала за последний год. Естественно, аккуратно, и держится долго.",
    service: "Брови",
  },
  {
    id: 3,
...
export const lashesFAQ: FAQItem[] = [
  { question: "Не испортит ли ламинирование ресницы?", answer: "Нет, если процедура выполнена правильно. Я подбираю состав индивидуально, чтобы не пересушить и не повредить ресницы." },
